...
const FolderListItem: React.FunctionComponent = () => {
  ...
  return (
    <StyledPressable style={style.boxShadow} className="flex-row bg-slate-50 px-3 py-5 active:opacity-75 rounded-lg dark:bg-transparent dark:border dark:border-slate-50">
